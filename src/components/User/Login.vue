    ...
    <div class="login-html">
      ...
      <div class="login-form">
        <div class="sign-in-htm">
          ...
          <div class="hr"></div>
          <div class="foot-lnk">
            <a href="#forgot" style="color:#fff;">忘记密码？</a>
          </div>
        </div>
        <div class="sign-up-htm">
          ...
          <div class="hr"></div>
          <div class="foot-lnk">
            <label for="tab-1" style="color:#fff;">已有账户？</label>
          </div>
        </div>
      </div>
    </div>
...
.login-wrap {
  ...
  background: url(https://cdn.pixabay.com/photo/2022/12/16/16/28/flowers-7660120_1280.jpg) no-repeat center;
